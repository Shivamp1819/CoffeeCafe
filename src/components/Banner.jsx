            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-center gap-6 sm:pt-0">
                    ...
                    <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi ab molestiae ad inventore quasi. Amet enim qui illo sapiente a, reprehenderit ipsa iusto dolor suscipit.
                    </p>
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div data-aos="slide-left" className="border-l-4 border-primary/50 pl-6 space-y-3">
                            ...
                            <p className="text-gray-500 text-sm">{""} Much like writing code, brewing the perfect cup of tea requirs atience, precision, and a dash of passion to create a comforting blend of flavours. </p>
                        </div>
